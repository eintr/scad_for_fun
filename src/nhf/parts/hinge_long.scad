...
module nhf_hinge_long(part="main", d=5, l=20, l0=5, gap=0.2) {
    ...
    if (part=="main") {
        ...
        cylinder(d=d+gap*2,h=l+gap*2,center=true,$fs=d/100);
...
nhf_hinge_long(d=10, l0=10, l=100);
difference() {
	#translate([0.1,0,-50]) cube(100);
	nhf_hinge_long(part="neg_side", d=10, l0=10, l=100);
}
translate([-100-0.1,0,-50]) cube(100);
